...
const EPUB_STYLES = {
  classic: `
    body { font-family: 'Georgia', 'Batang', serif; background: #f5f0e8; color: #2c2416; margin: 2em 3em; line-height: 1.85; }
    h1 { font-size: 2em; font-weight: 700; color: #1a0e00; border-bottom: 2px solid #8b6940; padding-bottom: 0.4em; margin-bottom: 1.2em; }
    h2 { font-size: 1.5em; font-weight: 600; color: #2c1e0a; margin: 1.5em 0 0.8em; }
    p { margin: 0 0 1.1em; text-indent: 1.5em; }
    p:first-of-type { text-indent: 0; }
  `,
  modern: `
    body { font-family: 'Apple SD Gothic Neo', 'Noto Sans KR', -apple-system, sans-serif; background: #ffffff; color: #1a1a1a; margin: 2em 3em; line-height: 1.8; }
    h1 { font-size: 1.9em; font-weight: 700; color: #000; margin-bottom: 1.2em; }
    h2 { font-size: 1.4em; font-weight: 600; color: #222; margin: 1.5em 0 0.8em; }
    p { margin: 0 0 1em; }
  `,
  minimal: `
    body { font-family: 'Helvetica Neue', 'Apple SD Gothic Neo', sans-serif; background: #f9f9f9; color: #111; margin: 2em 4em; line-height: 2; }
    h1 { font-size: 1.8em; font-weight: 900; text-transform: uppercase; letter-spacing: 0.05em; border-left: 5px solid #111; padding-left: 0.8em; margin-bottom: 1.5em; }
    h2 { font-size: 1.2em; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; color: #333; margin: 2em 0 0.6em; }
    p { margin: 0 0 1em; }
  `,
  warm: `
    body { font-family: 'Georgia', 'Batang', serif; background: #fdf6ec; color: #3e2a15; margin: 2.5em 3.5em; line-height: 2; }
    h1 { font-size: 2em; font-weight: 700; color: #5c3b1e; text-align: center; margin-bottom: 1.5em; }
    h2 { font-size: 1.4em; font-weight: 600; color: #7c5d42; margin: 2em 0 0.8em; }
...
function makeContentOpf(info, chapters, uid) {
...
<package xmlns="http://www.idpf.org/2007/opf" version="3.0" unique-identifier="uid">
  ...
  <manifest>
    ...
    <item id="title" href="chapter_title.xhtml" media-type="application/xhtml+xml"/>
${manifest}
  </manifest>
  <spine>
    <itemref idref="title"/>
...
async function buildEpub(info, chapters, styleKey, fontSize, onProgress) {
  const zip = new JSZip();
  ...
  zip.file('OEBPS/content.opf', makeContentOpf(info, allChapters, uid));
